...
`;
  ...
  const brandInfo = {
    ...
    'آیس بال': { name: 'آیس‌بال', englishName: 'IceBall', description: 'محصولات مراقبت پوستی - ترند، یخ، بستن منافذ، لیفت پوست 💦' },
    'آیس‌بال': { name: 'آیس‌بال', englishName: 'IceBall', description: 'محصولات مراقبت پوستی - ترند، یخ، بستن منافذ، لیفت پوست 💦' },
    'ایس بال': { name: 'آیس‌بال', englishName: 'IceBall', description: 'محصولات مراقبت پوستی - ترند، یخ، بستن منافذ، لیفت پوست 💦' },
    'iceball': { name: 'آیس‌بال', englishName: 'IceBall', description: 'محصولات مراقبت پوستی - ترند، یخ، بستن منافذ، لیفت پوست 💦' },
...
🏷️ برندها (فقط این 6 تا):
1. کلامین (Collamin) - محصولات مراقبت پوستی که از ترکیب کلامین با ویتامین‌های دیگه تولید میشه
2. میسویک (Misswake) - محصولات مراقبت دهان و دندان
3. آیس‌بال (IceBall) - محصولات مراقبت پوستی، ترند و یخی، بستن منافذ و لیفت پوست
4. دافی (Dafi) - دستمال مرطوب و پاک‌کننده‌های آرایشی
5. آمبرلا (Umbrella) - فقط دئودورانت (نه کرم!)
6. پیکسل (Pixxel) - ضدآفتاب سبک، هر دو کتگوری فیزیکال و شیمیایی

⚠️ نکات مهم برندها:
- کلامین = Collamin (نه Kalamine)
- پیکسل = Pixxel (دو x)
- آمبرلا فقط دئودورانت داره، کرم نداره
- دافی = دستمال مرطوب و پاک‌کننده آرایشی (نه لوازم خانگی!)
