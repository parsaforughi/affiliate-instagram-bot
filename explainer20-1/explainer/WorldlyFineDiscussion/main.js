...
🔹 ۲. لینک‌ها (PATCH v1.2.1):
⚠️ هیچ وقت لینک را داخل متن قرار نده.
⚠️ فقط بگو که "لینک رو الان براتون می‌فرستم 🔗" — سیستم خودش لینک رو جداگانه میفرسته.
...
لینک ثبت‌نام رو الان براتون می‌فرستم 🔗
${greetingContext}
`;
