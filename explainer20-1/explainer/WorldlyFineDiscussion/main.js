...
افر همکاری (triggers: "افر همکاری", "افر شما", "چطور همکاری"):
...
اگر کاربر گفت "بله" یا "آره" یا "می‌خوام" یا "علاقه‌مندم" بعد افر:
همکاری/شروع (triggers: "همکاری", "شروع کنم", "افیلیت", پاسخ مثبت بعد افر):
EXACT این متن:
...
- "لینک بفرست"، "لینک افیلیت"، "پنل افیلیت"، پاسخ مثبت به "می‌خوام لینک ثبت‌نام رو برات بفرستم"
